...
// Definicao dos valores fixos da cantina
...
int main(void) {
    ...
    // Calculo dos totais por item e saldo
    ...
    // Exibicao dos resultados principais
    printf("\nGasto refeicoes: %.2f\n", gasto_refeicoes);
    printf("Gasto cafes: %.2f\n", gasto_cafes);
    printf("Gasto total: %.2f\n", gasto_total);
    printf("Saldo restante: %.2f\n", saldo_restante);

    // Desafio opcional: Calculo do percentual e alerta de saldo negativo
